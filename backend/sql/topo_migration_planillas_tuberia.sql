...
CREATE TABLE IF NOT EXISTS topo_planillas_tuberia (
    ...
    nivel1_estado          VARCHAR(20) NOT NULL DEFAULT 'No Revisado',
    nivel1_usuario_id      INTEGER,
    nivel1_fecha           TIMESTAMPTZ,
    nivel2_estado          VARCHAR(20) NOT NULL DEFAULT 'No Revisado',
    nivel2_usuario_id      INTEGER,
    nivel2_fecha           TIMESTAMPTZ,
    comentario_interventoria TEXT,
    comentario_interventoria_at TIMESTAMPTZ,
