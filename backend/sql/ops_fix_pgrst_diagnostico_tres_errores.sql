-- =============================================================================
-- OPS URGENTE — pegar/ejecutar COMPLETO en Supabase → SQL Editor → Run
-- Corrige PGRST203 (bundle ambiguo), columna periodo (email), columnas live actas.
-- Idempotente. Misma lógica que migrations/20260916120000_fix_pgrst_diagnostico_tres_errores.sql
--
-- Verificación:
--   SELECT pg_get_function_identity_arguments(oid) FROM pg_proc
--     WHERE proname='dashboard_matriz_validacion_vigente_bundle';  -- solo (p_contrato_id bigint)
--   SELECT column_name FROM information_schema.columns
--     WHERE table_name='notificaciones_email_resumen_snapshot' AND column_name='periodo';
--   SELECT column_name FROM information_schema.columns
--     WHERE table_name='acta_grabacion_sesion' AND column_name='transcripcion';
-- =============================================================================
