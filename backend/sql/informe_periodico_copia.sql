-- Registro servidor de copia del modal «informe periódico» por ventana horaria.
...
DROP POLICY IF EXISTS informe_periodico_copia_service_all ON public.informe_periodico_copia;
-- Sin políticas para anon/authenticated: acceso vía backend (service_role).
