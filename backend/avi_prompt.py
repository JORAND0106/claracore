...
_MODULO_CONTEXTO_CORTO: Dict[str, str] = {
    ...
    "mapa_navegacion": "Mapa interactivo de funcionalidades: 7 módulos por ícono (Dashboard, Presupuesto, SICOE Obra, Informes, Almacén, Seguimiento, Topografía); al expandir se muestran grupos temáticos de capacitación (sin deep links).",
