...
/**
 * Lista devoluciones del contrato (o filtradas por salida) con opción de eliminar.
 * Al eliminar se recalculan saldos vía backend; el padre debe refrescar Salidas/Entradas.
 */
export default function DevolucionesListModal({
  ...
  const titulo = useMemo(() => {
    ...
    return 'Devoluciones registradas'
  }, [salidaId])
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 'var(--cc-sm)', color: ui.textMuted, marginTop: 4 }}>
              Elimine una devolución para recalcular saldos y poder borrar la salida / entrada asociadas.
            </div>
          </div>
