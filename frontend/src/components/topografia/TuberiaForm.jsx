    ...
    <div>
      ...
      <div style={{ ...ui.card, marginBottom: 16 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(140px,1fr))', gap: 8 }}>
          ...
          <input placeholder="Diametro" value={form.diametro_nominal} onChange={(e) => setForm({ ...form, diametro_nominal: e.target.value })} style={ui.inputStyle} />
          <input placeholder="Material" value={form.material} onChange={(e) => setForm({ ...form, material: e.target.value })} style={ui.inputStyle} />
        </div>
