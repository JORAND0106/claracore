...
export function bitacoraSheetStyles(t) {
  ...
  return {
    ...
    /** Barra de sección tipo Excel (encabezado reforzado sobre la grilla). */
    sectionBar: {
      display: 'flex',
      alignItems: 'center',
    ...
    /** Contenedor de grilla acoplado a sectionBar (sin doble borde superior). */
    sheetWrapFlush: {
      overflow: 'auto',
      border: `1px solid ${border}`,
      borderTop: 'none',
    ...
    /** Barra de sección independiente (cuando hay contenido entre título y grilla). */
    sectionBarSolo: {
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'space-between',
