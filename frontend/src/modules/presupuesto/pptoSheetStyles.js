/**
 * Estilos de grilla tipo Excel para Presupuesto
 * (mismo lenguaje visual que Bitácora / RRHH / Topografía / Almacén).
...
export function pptoSheetCssVars(t) {
  const ui = pptoSheetStyles(t)
  return {
    ...
    '--cc-ppto-sheet-header-bg': ui.th?.background || sheetHeaderTint(t?.primary, t?.bgCard),
  }
}

export function pptoSheetStyles(t) {
