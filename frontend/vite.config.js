...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '^/(auth|cargos|roles|contratos|usuarios|categorias|funciones|admin|mantenimiento|healthz|listado-precios|subcontratistas|presupuesto|cobro|contabilidad|almacen|exportar|cad-queue|claracad|cad/ejes|comentarios|logs|inicio|notificaciones|frase-del-dia|informes|actas|actas-tipos|sicoe-obra|guias|sst|prog-obra|avi|topografia|filtros-plantillas|presupuesto-versiones|test-telegram)': {
