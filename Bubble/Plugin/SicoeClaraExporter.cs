...
{
    public class DiscrepanciaRow
    {
        public int FilaIndex { get; set; }
        public string CapituloRecibido { get; set; } = "";
        public string CapituloSugerido { get; set; } = "";
        public string ItemRecibido { get; set; } = "";
        public string ItemSugerido { get; set; } = "";
        public string DescripcionRecibida { get; set; } = "";
        public string DescripcionCorrecta { get; set; } = "";
        public string UnidadRecibida { get; set; } = "";
        public string UnidadCorrecta { get; set; } = "";
        public double VlrUnitarioRecibido { get; set; }
        public double VlrUnitarioCorrecto { get; set; }
        public bool RequiereRecalculo { get; set; }
    }

    public class ValidacionResult
    {
        public bool TieneDiscrepancias { get; set; }
        public List<DiscrepanciaRow> Discrepancias { get; set; } = new();
    }
    ...
    public static class SicoeClaraExporter
    {
        ...
        /// </summary>
        public static async Task<(int enviados, string mensaje, ValidacionResult? validacion)> ExportAsync(
                    string baseUrl,
                    string token,
                    int contratoId,
                    ...
                    string mode = "append")
        {
            ...
            return (inserted, $"✅ {inserted} registros enviados correctamente a ClaraCore.", null);
        }
